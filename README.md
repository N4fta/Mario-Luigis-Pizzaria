...
<h4 align="center">A simple webshop built with HTML, CSS and deployed through Flask. It also interacts with an Arduino when an order is placed through a serial connection. </h4>
...
If the user was a Client, they would land on the Client page
